...
def performance(y_train_pred, y_train, y_test_pred, y_test, size=None):
  ...
  print("\nTest accuracy broken down per type: NOT COMPUTED")
...
# Amplitude encoding of 49*49=2401 > 2^11 = 2048 variables using 12 qubits (can encode up to 4096 inputs) 
...
d={'acc_train': tr_acc, 'accuracy': acc_scores, 'f1': f1_scores,
...
df.to_csv('./results/'+dim+'/qsvm_test_7x7.csv', index=False)
